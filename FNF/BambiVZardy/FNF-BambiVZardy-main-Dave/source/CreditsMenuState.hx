...
class CreditsMenuState extends MusicBeatState
{
   ...
   [
	  // Oh look its us //
      new Person("SMB", CreditsType.Bvz,
      [
         new Social('youtube', 'https://www.youtube.com/@SMB-5'), 
         new Social('twitter', 'https://twitter.com/SMB64585'),
         new Social('discord', 'https://discord.com/channels/@me'),
		 new Social('gamebanana', 'https://gamebanana.com/members/2445658')
      ]),
     
      new Person("Logatron", CreditsType.Bvz,
      [
         new Social('youtube', 'https://www.youtube.com/@Logatron64')
      ]),
      
      new Person("Atroxxious", CreditsType.Bvz,
      [
         new Social('youtube', 'https://www.youtube.com/@atroxxious'),
         new Social('twitter', 'https://twitter.com/smaldumb7')
      ]),
	...
	override function create()
	{
		...
		var bvz:Array<Person> = new Array<Person>();
		...
		for (i in 0...peopleInCredits.length)
		{
			...
			if (currentPerson == bvz[0] || currentPerson == developers[0] || currentPerson == translators[0] || currentPerson == contributors[0] || currentPerson == betaTesters[0]
				|| currentPerson == specialThanks[0])
			{
				switch (currentPerson.creditsType)
				{
					case Bvz:
						creditsTypeString = 'Bambi V Zardy';
						translatedCreditsType = LanguageManager.getTextString('credits_bvz');
					case Dev:
