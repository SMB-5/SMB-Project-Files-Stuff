...
class FreeplayState extends MusicBeatState
{
	...
	private var Catagories:Array<String> = ['dave'];
	...
	var songColors:Array<FlxColor> = [
		...
		0xFF800080, // FESTIVAL
		FlxColor.fromRGB(210, 105, 30), //ZARDY
	...
	public static var skipSelect:Array<String> = ['five-nights', 'vs-dave-rap', 'vs-dave-rap-two', 'larceny'];
	...
	public function LoadProperPack()
	{
		switch (Catagories[CurrentPack].toLowerCase())
		{
			...
			case 'dave':
				addWeek(['Larceny'], 5, ['zardyMyBeloved']);
			case 'joke':
