	...
	override public function create()
	{
		...
		if(SONG.stage == null)
		{
			switch(SONG.song.toLowerCase())
			{
				...
				case 'splitathon' | 'mealie' | 'shredder' | 'larceny':
					stageCheck = 'farm-night';
		...
		var noGFSongs = ['memory', 'five-nights', 'bot-trot', 'escape-from-california', 'overdrive', 'larceny'];
