...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		if (logoBl != null && gfDance != null)
		{
			...
			{
				case 2:
					addMoreText('Logatron');
				case 3:
					addMoreText('Atroxxious');
				case 4:
					addMoreText('Present');
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Port became real']);
				case 7:
					addMoreText('lets go!');
				case 8:
					deleteCoolText();
				...
				case 12:
					addMoreText("Bambi");
				case 13:
					addMoreText(awaitingExploitation ? 'Vs. Expunged' : 'VS');
				case 14:
					addMoreText(!awaitingExploitation ? 'Zardy' : 'The Full Mod');
				case 15:
					var text:String = !awaitingExploitation ? 'Dave Engine' : 'HAHAHHAHAHAHAHHAHAHAHAHHAHAHAHAHHAHA\nHAHAHHAHAHAHAHHAHAHAHAHHAHAHAHAHHAHA\nHAHAHHAHAHAHAHHAHAHAHAHHAHAHAHAHHAHA';
					if (awaitingExploitation)
