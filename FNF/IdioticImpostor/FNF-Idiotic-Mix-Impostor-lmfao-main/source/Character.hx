...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('GF_assetslol');
				frames = tex;
			...
			case 'impostor':
				tex = Paths.getSparrowAtlas('impostor-old','shared');
				frames = tex;
				animation.addByPrefix('idle', 'Impostor Idle', 12);
				animation.addByPrefix('singUP', 'Impostor Up', 12);
				animation.addByPrefix('singRIGHT', 'Impostor Forward', 12);
				animation.addByPrefix('singDOWN', 'Impostor Down', 12);
				animation.addByPrefix('singLEFT', 'Impostor Backwards', 12);

				addOffset('idle', 2, -34);
				addOffset("singUP", 18, 30);
				addOffset("singRIGHT", -31, -34);
				addOffset("singLEFT", 13, -34);
				addOffset("singDOWN", 42, -70);
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('BOYFRIENDlol','shared');
				frames = tex;
